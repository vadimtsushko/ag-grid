...
//  initialiseAgGridWithWebComponents();
  setLicenseKey(
      'InfoVizion_InfoVIzion_1Devs30_October_2018__MTU0MDg1NzYwMDAwMA==97b7051538dc8f2669ac2798fa0b5be4');
  ...
  gridOptions = new GridOptions(
      ...
      // changing to number, as scope keeps it as a string
  ...
  var changedUri = uri.replace(pathSegments: pathSegments);
  print(changedUri);
  allOfTheData =
      JSON.decode(await HttpRequest.getString(changedUri.toString()));
