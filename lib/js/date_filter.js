...
var emptyDate = new Date(1900,1,1).valueOf();
...
function millisecondsToRussianDateStr(milliseconds) {
...
var DateFilter = (function () {
    ...
    DateFilter.prototype.doesFilterPass = function (node) {
        ...
        //     valueAsDate = value;
        // } else {
        //     console.warn('invalid type - not a number: ' + value);
        //     return false;
        // }
    ...
    DateFilter.prototype.filterChanged = function () {
        console.log('DateFilter.filterChanged');
        ...
        this.api = {
            ...
            setFilter: function (filter) {
                ...
                if (filter === null) {
                    ...
                    that.eFilterTextField = '';
                    return;
                }
                if (typeof filter !== 'number') {
                    console.log('Error!!! DateFilter setFilter parameter should be of type number (millisecondsSinseEpoch)');
                    return;
                }
                // var newFilterDate = dateFromRussianStr(filter);
                // if (newFilterDate === emptyDate) {
                //    return;
                // }
                that.filterDate = filter;
                that.eFilterTextField.value = millisecondsToRussianDateStr(filter);
                // if (filter !== null) {
